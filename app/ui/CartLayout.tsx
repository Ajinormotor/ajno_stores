...
const CartLayout = () => {
  ...
  return (
<section className="flex flex-col lg:flex-row gap-3 p-5  h-full flex-grow py-5">

<div className="flex px-4  gap-3  md:max-w-[800px] w-full overflow auto">
...
{/* SUb total */}
<div  className="flex flex-col gap-2  border-[1px] border-black md:w-[400px] rounded-[10px] h-full max-h-[200px]">
    ...
    <div className="flex flex-col p-3">
        ...
        <ul  className="flex justify-between items-center">
            ...
            <li className="text-black">${totalAmount}</li>
        </ul>
...
<Link href={ `${totalItem === 0 ? "#" : "/Checkout"}  `}  className=" font-bold group-hover:text-black text-white  text-base"> <i className="ri-shopping-cart-fill group-hover:text-black text-white text-base"></i>  Check out</Link>
</button>
